...
**Marketing & Content** · **Repo 30/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/30-social-proof-wall/) · [Report an issue](https://github.com/volta-npo/30-social-proof-wall/issues) · [Volta](https://voltanpo.org)
...
```bash
git clone https://github.com/volta-npo/30-social-proof-wall.git
